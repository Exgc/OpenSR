...
class AVHubertPretrainingConfig(FairseqDataclass):
    ...
    modalities: Optional[List[str]] = field(default_factory=lambda: ["audio", "video"],
    ...
    noise_wav: Optional[str] = field(default=None,
...
class AVHubertPretrainingTask(FairseqTask):
    ...
    def load_tokenizer(self):
        bpe_args = Namespace(**{'bpe': self.cfg.tokenizer_bpe_name,
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        modalities = self.cfg.modalities #if split == 'train' else ['video']
