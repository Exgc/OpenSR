...
class myThread(threading.Thread):
    ...
    def run(self):
        print(self.threadID)
        detect_face_landmarks(args.face_predictor, args.cnn_detector, args.root, args.landmark, args.manifest,
                              self.threadID,
                              args.nshard)


def multi_detect_face_landmarks(nshard):
    threads = []
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='detecting facial landmarks',
    ...
    detect_face_landmarks(args.face_predictor, args.cnn_detector, args.root, args.landmark, args.manifest, args.rank,
                          args.nshard)
    # multi_detect_face_landmarks(args.nshard)